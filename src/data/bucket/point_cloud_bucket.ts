import {Pos3dArray} from '../array_types.g';

import {members as layoutAttributes} from './point_cloud_attributes';
...
import type {PointCloudStyleLayer} from '../../style/style_layer/point_cloud_style_layer';
 ...
 */
export class PointCloudBucket<Layer extends PointCloudStyleLayer > implements Bucket {
    index: number;
    zoom: number;
    overscaling: number;
    ...
    constructor(options: BucketParameters<Layer>) {
        ...
        this.layoutVertexArray = new Pos3dArray();
    ...
    populate(features: Array<IndexedFeature>, options: PopulateParameters, canonical: CanonicalTileID) {
        ...
        if (styleLayer.type === 'circle') {
            circleSortKey = (styleLayer as PointCloudStyleLayer).layout.get('circle-sort-key');
...
register('PointCloudBucket', PointCloudBucket, {omit: ['layers']});
